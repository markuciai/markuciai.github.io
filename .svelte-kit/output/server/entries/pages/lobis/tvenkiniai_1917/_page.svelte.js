...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-yjx469_START -->${$language == "EN" ? `${$$result.title = `<title>The Ponds — Markučiai Treasure</title>`, ""}
	...
	<meta name="description" content="Žaidimas">`}`}`}<!-- HEAD_svelte-yjx469_END -->`, ""}
