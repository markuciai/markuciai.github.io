...
const vanyusha = "/_app/immutable/assets/vanyusha.fae8b0ed.jpg";
const map_piece = "/_app/immutable/assets/6.505ca1d2.png";
const map = "/_app/immutable/assets/map-6.f716bcc3.png";
...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	...
	<p class="subh svelte-1sskqkw">Šeštoji stotelė<br>ieškant Markučių lobio</p>
	...
	<img width="105%"${add_attribute("src", vanyusha, 0)}>
