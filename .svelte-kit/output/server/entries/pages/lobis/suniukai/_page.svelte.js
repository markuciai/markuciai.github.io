...
const bowl = "/_app/immutable/assets/ball.a747149c.png";
const doggie = "/_app/immutable/assets/doggie.3dc9111a.jpg";
const map_piece = "/_app/immutable/assets/11.4abed4e5.png";
const map = "/_app/immutable/assets/map-11.faf951fd.png";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1oz33kl_START -->${$$result.title = `<title>Šuniukai – Markučių Lobis</title>`, ""}<meta name="description" content="Žaidimas"><!-- HEAD_svelte-1oz33kl_END -->`, ""}
...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	<h1 class="svelte-1sskqkw">Šuniukai</h1>
	<p class="subh svelte-1sskqkw">Vienuolitkoji stotelė<br>jieškant Markučių lobį</p>
	<article class="svelte-1sskqkw">Šaunuoliai! Radote mylimų Puškinų šunelių kapus. Staiga matote, kad Fankos ir Boikos (šuniukų vardai) palikuonys žaidžia su kroketo kamuoliuku. Taip neturi būti, nes šis kamuoliukas yra ne šuns žaislas!
	</article>


	<img width="105%"${add_attribute("src", doggie, 0)}>
	<article class="svelte-1sskqkw"><br></article>
	<img class="illustration svelte-1sskqkw"${add_attribute("src", bowl, 0)}>

	<div class="where-next svelte-1sskqkw">Kamuoliuką nedelsiant reikia nunešti kroketo žaidėjams. Keldami jį nuo žemės, pastebite dar vieną jau pažįstamo dokumento skiautę. Paimkite ją ir eikite ieškoti paskutinės dokumento dalies.
		<br><br>
		<span class="highlighted-question svelte-1sskqkw">Kur reikėtų ieškoti kroketo žaidėjų?</span></div></section>
