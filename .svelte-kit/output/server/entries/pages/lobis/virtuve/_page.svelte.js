...
const task = "/_app/immutable/assets/fodder.9b3cb03e.png";
const cook = "/_app/immutable/assets/cook.4d566727.png";
const map_piece = "/_app/immutable/assets/5.d5b04cde.png";
const map = "/_app/immutable/assets/map-5.d6dd650a.png";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-kp9h6g_START -->${$$result.title = `<title>Virtuvė – Markučių Lobis</title>`, ""}<meta name="description" content="Žaidimas"><!-- HEAD_svelte-kp9h6g_END -->`, ""}
...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	...
	<img width="105%"${add_attribute("src", cook, 0)}>
