...
const map = "/_app/immutable/assets/10.3668d023.png";
...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	...
	<p class="subh svelte-1sskqkw">Dešimtoji stotelė<br>ieškant Markučių lobio</p>
	...
	<img width="105%"${add_attribute("src", cerkve, 0)}>
