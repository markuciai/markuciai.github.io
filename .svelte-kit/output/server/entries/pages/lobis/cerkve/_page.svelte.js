...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1x8k2zx_START -->${$$result.title = `<title>Cerkvė – Markučių Lobis</title>`, ""}<meta name="description" content="Žaidimas"><!-- HEAD_svelte-1x8k2zx_END -->`, ""}
...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	...
	<article class="svelte-1sskqkw">Padėję gėles ant kapų, atsisukite į cerkvę ir raskite datą – kuriais metais buvo pradėtos šios namų cerkvės – koplyčios statybos? Ji buvo pašventinta šventosios kankinės Barboros vardu. Šalia bažnyčios aptinkate dar vieną dokumento skiautę. Apeikite kapinaites.
	</article>
	...
	<div class="where-next svelte-1sskqkw">Sekančią dokumento dalį jums padės surasti keturkojai Puškinų šeimos draugai.
		<br><br>
		<span class="highlighted-question svelte-1sskqkw">Ko reikėtų ieškoti kapinaitėse?</span></div></section>
