...
<section class="svelte-1sskqkw"><img class="illustration svelte-1sskqkw"${add_attribute("src", map_piece, 0)}>
	<h1 class="svelte-1sskqkw">Kryžius</h1>
	<p class="subh svelte-1sskqkw">Pirmoji stotelė<br>jieškant Markučių lobį</p>
	<article class="svelte-1sskqkw">Varvaros Puškinos laikais, prie įėjimo į parką iš kairės pusės ant akmeninio postamento stovėjo aukštas, iš geležinkelio bėgių pagamintas kryžius. Prie pat jo pamatų dvaro šeimininkė palikdavo monetų pilną indelį skirtą vargingiems žmonėms. 	</article>
	...
	<div class="where-next svelte-1sskqkw">Kam vertėtų parodyti keistąjį radinį? Galbūt dvaro tarnai galėtų jums padėti?
		<br><br>
		<span class="highlighted-question svelte-1sskqkw">Kur reikėtų ieškoti tarnų?</span></div></section>
