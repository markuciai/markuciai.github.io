...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-12wdz4o_START -->${$language == "EN" ? `${$$result.title = `<title>Kitchen — Markučiai Treasure</title>`, ""}
	...
	<meta name="description" content="Žaidimas">`}`}`}<!-- HEAD_svelte-12wdz4o_END -->`, ""}
